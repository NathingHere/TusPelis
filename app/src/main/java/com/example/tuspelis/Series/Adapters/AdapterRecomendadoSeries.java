...
public class AdapterRecomendadoSeries extends RecyclerView.Adapter<AdapterRecomendadoSeries.RecomendadoHolder>{

    private List<Serie> serie;
    private Context context;

    public AdapterRecomendadoSeries(List<Serie> serie, Context context) {
        this.serie = serie;
